...
export function FeedbackButton() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen(v => !v)}
        className="fixed bottom-24 lg:bottom-6 right-4 lg:right-6 z-50 flex items-center gap-2 rounded-full bg-primary px-4 py-2.5 text-white shadow-lg shadow-primary/25 hover:bg-primary/90 transition-all active:scale-95"
      ...
      {/* Panel */}
      {open && (
        <div className="fixed bottom-36 lg:bottom-20 right-4 lg:right-6 z-50 w-[calc(100vw-2rem)] max-w-sm rounded-2xl border border-border bg-card shadow-2xl shadow-black/40">
