...
if not main_activity_dir:
    ...
    content = (
        ...
        "    private String pendingAuthKey = null;\n\n"
        "    @Override\n"
        ...
        "                        if (\"emergenthealth.vercel.app\".equals(uri.getHost())\n"
        "                                && \"/mobile-signin\".equals(uri.getPath())) {\n"
        "                            String k = uri.getQueryParameter(\"auth_key\");\n"
        "                            if (k != null && !k.isEmpty()) pendingAuthKey = k;\n"
        "                        }\n"
        ...
        "                        // Reload /mobile-signin so its polling script keeps running\n"
        "                        // while Chrome handles OAuth. sessionStorage prevents re-submit.\n"
        "                        if (pendingAuthKey != null) {\n"
        "                            final String k = pendingAuthKey;\n"
